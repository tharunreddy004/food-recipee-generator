...
// // Example prompt texts curated for classification
...
// // Cached arrays to hold { text, embedding }
// // export let foodExamples = [];
// // export let irrelevantExamples = [];
...
// /**
//  * Precompute embeddings for example texts, cache into module vars
//  */
...
// export type Example = { text: string; embedding: number[] };
