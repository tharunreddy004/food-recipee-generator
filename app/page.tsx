...
export default function Home() {
  ...
  // Load answered prompt from URL query if present
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-yellow-50 flex flex-col items-center justify-center p-6 print:bg-white">
      <h1 className="text-4xl font-bold mb-6 text-gray-900 text-center">Food Recipe Generator</h1>
      <div className="max-w-3xl w-full space-y-5">
        ...
        <input
          ...
          className="w-full rounded-md border border-yellow-400 p-3 focus:outline-none focus:ring-2 focus:ring-yellow-500 text-gray-900"
        />
        <button
        ...
        {result && result.resultType === "recipe" && (
          <>
            ...
            <section
              aria-live="polite"
              className="bg-white rounded-lg shadow-lg p-8 max-w-full mx-auto my-8 prose prose-lg text-gray-900 leading-relaxed print-recipe"
              style={{
                wordBreak: "break-word",
                whiteSpace: "pre-line",
                overflowX: "hidden",
                // Remove scroll for print view
              }}
            >
